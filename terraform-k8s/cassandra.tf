#Optional TODO: attach Cassandra web UI as ambassador
#Optional TODO: deploy Cassandra as StatefulSet
#Optional TODO: configure health checks and readiness probes
